...
const pokeImage = (url) =>{
    ...
    pokeImg.src = url;
    document.getElementById("pokeImg").style.backgroundColor ='#0cf1e9';  
}
...
function setAttack(attack){
    ...
    if(values[2]>=100){
        document.getElementById("attack_1").style.background = '#b11e2c';
        document.getElementById("attack_2").style.background = '#b11e2c';
        document.getElementById("attack_3").style.background = '#b11e2c';
        fourStar[0] = true;
    }else{
        document.getElementById("attack_1").style.background = '#65ee52';
        document.getElementById("attack_2").style.background = '#65ee52';
        document.getElementById("attack_3").style.background = '#65ee52';
        fourStar[0] = false;
    }
}
...
function setDefense(defense){
    ...
    if(values[2]>=100){
        document.getElementById("defense_1").style.background = '#b11e2c';
        document.getElementById("defense_2").style.background = '#b11e2c';
        document.getElementById("defense_3").style.background = '#b11e2c';
        fourStar[1] = true;
    }else{
        document.getElementById("defense_1").style.background = '#65ee52';
        document.getElementById("defense_2").style.background = '#65ee52';
        document.getElementById("defense_3").style.background = '##65ee52';
        fourStar[1] = false;
    }
}
...
function setHP(HP){
    ...
    if(values[2]>=100){
        document.getElementById("hp_1").style.background = '#b11e2c';
        document.getElementById("hp_2").style.background = '#b11e2c';
        document.getElementById("hp_3").style.background = '#b11e2c';
        fourStar[2] = true;
    }else{
        document.getElementById("hp_1").style.background = '#65ee52';
        document.getElementById("hp_2").style.background = '#65ee52';
        document.getElementById("hp_3").style.background = '#65ee52';
        fourStar[2] = false;
    }
}